# editing_messages_of_different_types/bot.py
...
async def main() -> None:
    ...
    # Сохраняем объект bot в хранилище workflow_data диспетчера dp. Это позволит использовать один и тот же объект bot
    # во всех обработчиках без необходимости явно передавать его из функции в функцию
